...
| OpenAPI compacto sin nuevas operaciones | GPT Actions compact | `ActivityCostInput.processingMode=auto`, `sourceEventLogId`; 30 operaciones intactas | No aplica | implemented_backend | `audit:openapi-compact` OK con 30 operaciones. | Pegar schema compacto actualizado en GPT Builder. |
