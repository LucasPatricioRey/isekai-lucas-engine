...
| NPCs, conocimiento, escena viva | `rules_engine.md` 18; `world_bible.md` 11 | `Npc`, `NpcMemory`, `RoutineOverride`, `NpcRelationship`, `getNpcFull`; seeds core/social/rumors/emotions preparados | 25 NPCs de Hoshimori vivos; 4 memorias G4 vivas; rumores G5 distribuidos por NPC/location; C15 agrega emotionalProfile a los 25 NPCs | partial | `audit:hoshimori-core`, `audit:hoshimori-social`, `audit:hoshimori-rumors`, `audit:narrative-drama` y `audit:npc-emotions` | Ampliar memoria privada solo con canon verificable; no hacer NPCs omniscientes |
