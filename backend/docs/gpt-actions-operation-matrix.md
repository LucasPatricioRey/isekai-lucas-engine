...
- `applyTurn.magicPatches` no suma operacion: guarda desbloqueos de ramas magicas y conocimiento formal de tecnicas/hechizos; la teoria o practica sin este patch no crea hechizos reales.
